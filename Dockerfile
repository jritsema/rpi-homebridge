...
RUN apt-get update && apt-get install -y \
    wget build-essential curl git apt-transport-https python make g++ avahi-daemon avahi-discover libnss-mdns libavahi-compat-libdnssd-dev libkrb5-dev net-tools
